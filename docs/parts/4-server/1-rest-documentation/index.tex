...
\input{parts/4-server/1-rest-documentation/root/index}

\input{parts/4-server/1-rest-documentation/acp/index}

\input{parts/4-server/1-rest-documentation/menu/index}

\input{parts/4-server/1-rest-documentation/product/index}

\input{parts/4-server/1-rest-documentation/order/index}

\input{parts/4-server/1-rest-documentation/user/index}
