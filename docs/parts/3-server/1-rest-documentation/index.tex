...
Die Funktionsweise der \textit{Bearer-Authorization} steckt in ihrem Namen. Sie gibt dem \glqq Bearer\grqq, zu Deutsch dem \glqq Inhaber\grqq eines Zugriff-Tokens, Zugriff auf eine Ressource. \cite{levin2019}
